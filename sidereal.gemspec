...
require_relative "lib/sidereal/version"

Gem::Specification.new do |spec|
  spec.name = "sidereal"
  spec.version = Sidereal::VERSION
  ...
  spec.metadata["mailing_list_uri"]   = "https://www.rubyforum.org/tag/sidereal"
  ...
  spec.files = IO.popen(%w[git ls-files -z], chdir: __dir__, err: IO::NULL) do |ls|
    ls.readlines("\x0", chomp: true).reject do |f|
      (f == gemspec) ||
        f.start_with?(*%w[bin/ Gemfile .gitignore .rspec spec/ examples/])
    end
  end
  spec.bindir = 'exe'
